...
module Jekyll
  class PodcastFeed < Jekyll::Generator
    safe true
    priority :lowest
    ...
    def generate(site)
      ...
      Jekyll.logger.info "Jekyll Podcast:", "Generating podcast feed"
      @site = site
    ...
    def feed_path(collection: "episodes", category: nil)
    ...
    def make_page(file_path, collection: "episodes", category: nil)
